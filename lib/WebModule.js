...
GLOBAL.$keys   = function(o, keys, ig) { return GLOBAL.Valid ? GLOBAL.Valid.keys(o, keys, ig)   : true; };
GLOBAL.$values = function(o, vals, ig) { return GLOBAL.Valid ? GLOBAL.Valid.values(o, vals, ig) : true; };
