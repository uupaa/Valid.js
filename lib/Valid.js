...
Valid["type"]       = function() { return true; };
Valid["keys"]       = function() { return true; };
Valid["json"]       = function() { return true; };
Valid["stack"]      = function() { return ""; };
Valid["assert"]     = function() {};
...
Valid["assert"]     = Valid_assert;// Valid.assert(fn:Function, hint:String):void
//}@dev
...
//{@dev
function Valid_assert(fn,     // @arg Function:
                      hint) { // @arg String:
                              // @help: Valid.assert
    // dump stack trace
    console.error( Valid_stack( fn.name + " " + hint ) );
