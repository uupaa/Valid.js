...
function Valid_type(value,   // @arg Any
    ...
    function _some(type) { // @arg NativeTypeNameString|SpecialTypeNameString|ComplexTypeNameString
        ...
        case "Int32":       return isInt(value)  && value <= 0x7fffffff && value >= -0x80000000;
        case "Int16":       return isInt(value)  && value <= 0x7fff     && value >= -0x8000;
        case "Int8":        return isInt(value)  && value <= 0x7f       && value >= -0x80;
        case "Uint32":      return isUint(value) && value <= 0xffffffff;
        case "Uint16":      return isUint(value) && value <= 0xffff;
        case "Uint8":       return isUint(value) && value <= 0xff;
        // --- color ---
        case "AARRGGBB":
        case "RRGGBBAA":    return isUint(value) && value <= 0xffffffff; // Uint32
        case "RRGGBB":      return isUint(value) && value <= 0xffffff;   // Uint24
        }
